			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					<?php foreach ($dr_analys as $row){?>
                        <div class="card-body">
								...
								<div class="form-check">
									...
									<br>
									<input class="form-check-input" type="checkbox" disabled <?php if($row->nk3_check ==1 || $row->nk3_check == 'on'){echo 'checked';};?>  name="nk3_check"
										id="defaultCheck2">
									<label class="form-check-label" for="defaultCheck2">
										NK3
									</label>
									<br>
									<input class="form-check-input" type="checkbox" disabled <?php if($row->data_debitur_check ==1 || $row->data_debitur_check ==  'on'){echo 'checked';};?> name="data_debitur_check"
										id="defaultCheck2">
									<label class="form-check-label" for="defaultCheck2">
										data debitur
									</label>
									<br>
									<input class="form-check-input" type="checkbox" disabled <?php if($row->pak_check ==1 || $row->pak_check == 'on'){echo 'checked';};?> name="pak_check"
										id="defaultCheck2">
									<label class="form-check-label" for="defaultCheck2">
										PAK
									</label>
									<br>
									<input class="form-check-input" type="checkbox" disabled <?php if($row->fia_check ==1 || $row->fia_check == 'on'){echo 'checked';};?> name="fia_check"
										id="defaultCheck2">
									<label class="form-check-label" for="defaultCheck2">
										FIA
									</label> <br>
									<input class="form-check-input" type="checkbox" disabled <?php if($row->ipk_check ==1 || $row->ipk_check == 'on'){echo 'checked';};?> name="ipk_check"
										id="defaultCheck2">
									<label class="form-check-label" for="defaultCheck2">
										IPK/MRK
									</label>
					...
					<div class="card card-orange">
						...
						<form action="<?php echo base_url('BerandaPengelola/ubah_dokumen2');?>" method="post">
							...
							<div class="card-body">
								<div class="form-group">
									...
									<label>Pemimpin Kelompok</label>
									<select class="form-control select2" name="id_penerus" style="width: 100%;">
										<option value="">------Pemimpin Kelompok------</option>
