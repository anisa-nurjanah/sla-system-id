		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-md-12">
							...
							<div class="card-body">
                                ...
                                <?php if($history->file_2 !==''){;?>
                                    <div class="form-group">
                                        ...
                                        <a href="<?php echo base_url('assets/document/'.$row->file_2);?>"
                                            target="_blank">Download File</a>
                                    </div>
                                <?php };?>
					...
					<div class="card card-orange">
						<div class="card-header">
							<h3 class="card-title">Detail Dokumen <?php echo $history->nama_penerus;?></h3>
						</div>

						<form action="<?php echo base_url('BerandaPimpinan/ubah_dokumen3');?>" method="post">
